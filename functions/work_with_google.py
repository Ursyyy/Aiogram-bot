...
def RecreateCompaniesTable():
	companies_data = GetSpreadsheetData("PayForSay_Database", 1)
...
def RecreateManagersTable():
	managers_data = GetSpreadsheetData("PayForSay_Database", 2)
...
def RecreateUserTable():
	usersegments_data = GetSpreadsheetData("PayForSay_Database", 3)
...
def RecreateOrgTable():
	org_data = GetSpreadsheetData("PayForSay_Database", 4)
...
def RecreateCatTable():
	cat_data = GetSpreadsheetData("PayForSay_Database", 5)
